...
public class ProductosController {
    ...
    public String mostrarFormularioEdicion(@PathVariable int codigo, Model model) {
    ...
    public String eliminar(@PathVariable int codigo, RedirectAttributes redirectAttributes) {
        try {
